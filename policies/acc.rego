...
# Consent policy for the Accident Compensation Corporation (ACC) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-acc`. Every cross-department DATA_REQUEST
...
# the ACC node because the citizen has implicit consent over their own record.
