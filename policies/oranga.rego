package oranga.consent

# Consent policy for the Oranga Tamariki department node.
#
# Mirrors `src/consent.rs` in `gov-dept-oranga`. Every cross-department DATA_REQUEST
...
# the oranga node because the citizen has implicit consent over their own record.
