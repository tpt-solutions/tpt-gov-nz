package pacific.consent

# Consent policy for the Ministry for Pacific Peoples department node.
#
# Mirrors `src/consent.rs` in `gov-dept-pacific`. Every cross-department DATA_REQUEST
...
# the pacific node because the citizen has implicit consent over their own record.
