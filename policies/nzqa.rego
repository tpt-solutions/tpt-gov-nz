package nzqa.consent

# Consent policy for the Ministry of Education / NZQA department node.
#
# Mirrors `src/consent.rs` in `gov-dept-nzqa`. Every cross-department DATA_REQUEST
...
# the NZQA node because the citizen has implicit consent over their own record.
