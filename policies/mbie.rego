package mbie.consent

# Consent policy for the Ministry of Business, Innovation and Employment (MBIE)
# department node.
#
# Mirrors `src/consent.rs` in `gov-dept-mbie`. Every cross-department DATA_REQUEST
...
# the MBIE node because the citizen has implicit consent over their own record.
