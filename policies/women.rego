package women.consent

# Consent policy for the Ministry for Women department node.
#
# Mirrors `src/consent.rs` in `gov-dept-women`. Every cross-department DATA_REQUEST
...
# the women node because the citizen has implicit consent over their own record.
