...
# Consent policy for the Te Puni Kōkiri (Ministry of Māori Development) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-tpk`. Every cross-department DATA_REQUEST
...
# the TPK node because the citizen has implicit consent over their own record.
