package treasury.consent

# Consent policy for the The Treasury department node.
#
# Mirrors `src/consent.rs` in `gov-dept-treasury`. Every cross-department DATA_REQUEST
...
# the treasury node because the citizen has implicit consent over their own record.
