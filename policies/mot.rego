...
# Consent policy for the Ministry of Transport department node.
#
# Mirrors `src/consent.rs` in `gov-dept-mot`. Every cross-department DATA_REQUEST
...
# the mot node because the citizen has implicit consent over their own record.
