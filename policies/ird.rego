...
# Consent policy for the Inland Revenue (IRD) department node.
#
# This policy is the source of truth deployed to the OPA sidecar that sits in
# front of the IRD department service. The Rust `gov-dept-ird` crate mirrors the
...
# policy — the IRD node authorises those paths directly because the citizen has
