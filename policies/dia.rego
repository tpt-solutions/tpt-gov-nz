...
# Consent policy for the Department of Internal Affairs (DIA) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-dia`. Every cross-department DATA_REQUEST
...
# the DIA node because the citizen has implicit consent over their own record.
