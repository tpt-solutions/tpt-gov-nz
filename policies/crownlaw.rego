package crownlaw.consent

# Consent policy for the Crown Law Office department node.
#
# Mirrors `src/consent.rs` in `gov-dept-crownlaw`. Every cross-department DATA_REQUEST
...
# the crownlaw node because the citizen has implicit consent over their own record.
