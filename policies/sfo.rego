...
# Consent policy for the Serious Fraud Office department node.
#
# Mirrors `src/consent.rs` in `gov-dept-sfo`. Every cross-department DATA_REQUEST
...
# the sfo node because the citizen has implicit consent over their own record.
