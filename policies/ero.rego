...
# Consent policy for the Education Review Office department node.
#
# Mirrors `src/consent.rs` in `gov-dept-ero`. Every cross-department DATA_REQUEST
...
# the ero node because the citizen has implicit consent over their own record.
