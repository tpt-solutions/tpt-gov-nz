package police.consent

# Consent policy for the New Zealand Police department node.
#
# Mirrors `src/consent.rs` in `gov-dept-police`. Every cross-department DATA_REQUEST
...
# the Police node because the citizen has implicit consent over their own record.
