...
# Consent policy for the Ministry for Culture and Heritage department node.
#
# Mirrors `src/consent.rs` in `gov-dept-mch`. Every cross-department DATA_REQUEST
...
# the mch node because the citizen has implicit consent over their own record.
