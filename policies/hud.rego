...
# Consent policy for the Ministry of Housing and Urban Development / Kāinga Ora
# (HUD) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-hud`. Every cross-department DATA_REQUEST
...
# the HUD node because the citizen has implicit consent over their own record.
