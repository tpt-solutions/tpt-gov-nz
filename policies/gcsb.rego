package gcsb.consent

# Consent policy for the Government Communications Security Bureau department node.
#
# Mirrors `src/consent.rs` in `gov-dept-gcsb`. Every cross-department DATA_REQUEST
...
# the gcsb node because the citizen has implicit consent over their own record.
