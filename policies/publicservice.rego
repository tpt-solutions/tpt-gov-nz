package publicservice.consent

# Consent policy for the Te Kawa Mataaho Public Service Commission department node.
#
# Mirrors `src/consent.rs` in `gov-dept-publicservice`. Every cross-department DATA_REQUEST
...
# the publicservice node because the citizen has implicit consent over their own record.
