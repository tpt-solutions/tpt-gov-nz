package corrections.consent

# Consent policy for the Department of Corrections department node.
#
# Mirrors `src/consent.rs` in `gov-dept-corrections`. Every cross-department DATA_REQUEST
...
# the Corrections node because the citizen has implicit consent over their own record.
