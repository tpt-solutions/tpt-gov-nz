package mfat.consent

# Consent policy for the Ministry of Foreign Affairs and Trade department node.
#
# Mirrors `src/consent.rs` in `gov-dept-mfat`. Every cross-department DATA_REQUEST
...
# the mfat node because the citizen has implicit consent over their own record.
