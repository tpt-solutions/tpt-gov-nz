package ethnic.consent

# Consent policy for the Ministry for Ethnic Communities department node.
#
# Mirrors `src/consent.rs` in `gov-dept-ethnic`. Every cross-department DATA_REQUEST
...
# the ethnic node because the citizen has implicit consent over their own record.
