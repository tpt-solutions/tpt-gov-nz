package nzdf.consent

# Consent policy for the New Zealand Defence Force department node.
#
# Mirrors `src/consent.rs` in `gov-dept-nzdf`. Every cross-department DATA_REQUEST
...
# the nzdf node because the citizen has implicit consent over their own record.
