...
# Consent policy for the Civil Aviation Authority department node.
#
# Mirrors `src/consent.rs` in `gov-dept-caa`. Every cross-department DATA_REQUEST
...
# the caa node because the citizen has implicit consent over their own record.
