...
# Consent policy for the Department of Conservation (DOC) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-doc`. Every cross-department DATA_REQUEST
...
# the DOC node because the citizen has implicit consent over their own record.
