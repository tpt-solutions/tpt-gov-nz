package nzta.consent

# Consent policy for the NZ Transport Agency (NZTA) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-nzta`. Every cross-department DATA_REQUEST
...
# the NZTA node because the citizen has implicit consent over their own record.
