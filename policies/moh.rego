...
# Consent policy for the Ministry of Health (MOH) department node.
#
# This policy is the source of truth deployed to the OPA sidecar that sits in
# front of the MOH department service. The Rust `gov-dept-moh` crate mirrors the
...
# policy — the MOH node authorises those paths directly because the citizen has
