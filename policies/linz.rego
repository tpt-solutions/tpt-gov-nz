package linz.consent

# Consent policy for Toitū Te Whenua Land Information New Zealand (LINZ)
# department node.
#
# Mirrors `src/consent.rs` in `gov-dept-linz`. Every cross-department DATA_REQUEST
...
# the LINZ node because the citizen has implicit consent over their own record.
