package tearawhiti.consent

# Consent policy for the Te Arawhiti department node.
#
# Mirrors `src/consent.rs` in `gov-dept-tearawhiti`. Every cross-department DATA_REQUEST
...
# the tearawhiti node because the citizen has implicit consent over their own record.
