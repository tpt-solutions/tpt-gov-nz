...
# Consent policy for the Ministry for the Environment department node.
#
# Mirrors `src/consent.rs` in `gov-dept-mfe`. Every cross-department DATA_REQUEST
...
# the mfe node because the citizen has implicit consent over their own record.
