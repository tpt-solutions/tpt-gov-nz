package dpmc.consent

# Consent policy for the Department of the Prime Minister and Cabinet department node.
#
# Mirrors `src/consent.rs` in `gov-dept-dpmc`. Every cross-department DATA_REQUEST
...
# the dpmc node because the citizen has implicit consent over their own record.
