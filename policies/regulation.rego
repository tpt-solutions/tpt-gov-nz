package regulation.consent

# Consent policy for the Ministry for Regulation department node.
#
# Mirrors `src/consent.rs` in `gov-dept-regulation`. Every cross-department DATA_REQUEST
...
# the regulation node because the citizen has implicit consent over their own record.
