package defence.consent

# Consent policy for the Ministry of Defence department node.
#
# Mirrors `src/consent.rs` in `gov-dept-defence`. Every cross-department DATA_REQUEST
...
# the defence node because the citizen has implicit consent over their own record.
