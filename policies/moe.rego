...
# Consent policy for the Ministry of Education department node.
#
# Mirrors `src/consent.rs` in `gov-dept-moe`. Every cross-department DATA_REQUEST
...
# the moe node because the citizen has implicit consent over their own record.
