package fenz.consent

# Consent policy for the Fire and Emergency New Zealand department node.
#
# Mirrors `src/consent.rs` in `gov-dept-fenz`. Every cross-department DATA_REQUEST
...
# the fenz node because the citizen has implicit consent over their own record.
