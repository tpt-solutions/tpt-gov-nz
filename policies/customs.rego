package customs.consent

# Consent policy for the New Zealand Customs Service department node.
#
# Mirrors `src/consent.rs` in `gov-dept-customs`. Every cross-department DATA_REQUEST
...
# the Customs node because the citizen has implicit consent over their own record.
