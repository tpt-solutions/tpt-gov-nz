package retirement.consent

# Consent policy for the Retirement Commission (Te Ara Ahunga Ora) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-retirement`. Every cross-department DATA_REQUEST
...
# the retirement node because the citizen has implicit consent over their own record.
