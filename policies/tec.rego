...
# Consent policy for the Tertiary Education Commission department node.
#
# Mirrors `src/consent.rs` in `gov-dept-tec`. Every cross-department DATA_REQUEST
...
# the tec node because the citizen has implicit consent over their own record.
