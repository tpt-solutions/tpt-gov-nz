package maritime.consent

# Consent policy for the Maritime New Zealand department node.
#
# Mirrors `src/consent.rs` in `gov-dept-maritime`. Every cross-department DATA_REQUEST
...
# the maritime node because the citizen has implicit consent over their own record.
