...
# Consent policy for the Earthquake Commission (Toka Tū Ake) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-eqc`. Every cross-department DATA_REQUEST
...
# the eqc node because the citizen has implicit consent over their own record.
