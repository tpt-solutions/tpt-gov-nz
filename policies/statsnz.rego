package statsnz.consent

# Consent policy for the Statistics New Zealand department node.
#
# Mirrors `src/consent.rs` in `gov-dept-statsnz`. Every cross-department DATA_REQUEST
...
# the Stats NZ node because the citizen has implicit consent over their own record.
