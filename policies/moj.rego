...
# Consent policy for the Ministry of Justice (MOJ) department node.
#
# Mirrors `src/consent.rs` in `gov-dept-moj`. Every cross-department DATA_REQUEST
...
# the MOJ node because the citizen has implicit consent over their own record.
