package worksafe.consent

# Consent policy for the WorkSafe New Zealand department node.
#
# Mirrors `src/consent.rs` in `gov-dept-worksafe`. Every cross-department DATA_REQUEST
...
# the worksafe node because the citizen has implicit consent over their own record.
