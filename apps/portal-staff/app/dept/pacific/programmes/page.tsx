...
export const metadata = { title: "Programmes — Ministry for Pacific Peoples — Case File — My Gov NZ" };

type SearchParams = { did?: string };

export default async function PacificProgrammesStaffPage({
  searchParams,
}: {
  ...
  const data = await fetchPacificDataForCitizen(did, ["pacific:programmes"]);
